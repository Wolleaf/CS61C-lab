...
recursion:
    ...
    # THINK: Why a0? Because we'll call square func, and a0 is the argument
    ### YOUR CODE HERE ###
    lw a0, 0(s0)
    ...
    # THINK: why a1? What about a0? a0 is the node address. a1 is the second parameter
    ### YOUR CODE HERE ###
    add a1, s1, x0
